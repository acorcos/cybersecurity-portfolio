...
However, several important controls and compliance best practices are missing or insufficient. The most critical gaps include lack of least privilege, lack of separation of duties, weak password policies, no centralized password management system, no encryption for credit card data, no IDS, no backups, and no disaster recovery plan.
